...
export async function seed(knex: Knex): Promise<void> {
  ...
  const timeTableId: Array<{ id: number }> = await knex("time_table")
    .insert([
    ...
    .insert([
      {
        ...
        first_name: "Tomas",
        last_name: "Aldrich",
        email: "taldrichdf@wikispaces.com",
        phone_num: "85315753",
        identity: "teacher",
      },
      {
      ...
      },
      {
        ...
        first_name: "David",
        last_name: "Petras",
        email: "dpetrashy@cyberchimps.com",
        phone_num: "73312086",
        identity: "teacher",
      },
    ])
  ...
  const teacherDataId: Array<{ id: number }> = await knex("teachers")
    .insert([
      {
        teacher_image: "teacher_icon.png",
        teacher_description: "Teaching Sign Language at HKU",
        user_id: teacherId[0].id,
      },
      {
        teacher_image: "teacher_icon.png",
        teacher_description: "Professor of Sign Language",
        user_id: teacherId[1].id,
      },
      {
        teacher_image: "teacher_icon.png",
        teacher_description: "The First of Sign Language on 'TIme'",
        user_id: teacherId[2].id,
      },
    ])
    .returning("id");
