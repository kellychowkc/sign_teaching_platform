...
function loadTeachingData(){
    ...
    xhttp.open("GET","/html/admin.html",true)
}
        ...
        <div class="words_form">
            <form action="/action_page.php">
                ...
                <div class="table-section">
                    ...
                    <!-- <div class="word">
                    <label for="麵包">麵包</label>
                    <input type="radio" id="麵包" name="words" value="麵包">
                </div>
                <div class="word">
                    <label for="麵包">麵包</label>
                    <input type="radio" id="麵包" name="words" value="麵包">
...
`;
    ...
    //table list
    //pageNumb
    const newContentRight = `<form action="/action_page.php" class="content_form">
    <div class="container">
        <h1>上載影片</h1>
        <hr /><br>
        ...
        <hr />
        <button class='registerbtn' type='submit'>上載</button>
