...
userInfoRoutes.post(
  "/displayCanTeachingTime",
  isLoggedInTeacher,
  teacherController.displayCanTeachingTime
);
userInfoRoutes.post(
  "/editCanTeachingTime",
  isLoggedInTeacher,
  teacherController.editCanTeachingTime
);
userInfoRoutes.post(
  "/displayTeachingRecord",
  isLoggedInTeacher,
  teacherController.displayTeachingRecord
);
userInfoRoutes.post(
  "/displayLessonForTeacher",
  isLoggedInTeacher,
  teacherController.displayLessonForTeacher
);
userInfoRoutes.post(
  "/displayThatLessonData",
  isLoggedInTeacher,
  teacherController.displayThatLessonData
);
...
userInfoRoutes.post(
  ...
  isLoggedInStudent,
  studentController.displayTeacherTimeTable
);
...
userInfoRoutes.post(
  "/displayPackagesRecord",
  isLoggedInStudent,
  studentController.displayPackagesRecord
);
...
userInfoRoutes.post(
  "/displayLessonForStudent",
  isLoggedInStudent,
  studentController.displayLessonForStudent
);
userInfoRoutes.post(
  "/displayThisLessonData",
  isLoggedInStudent,
  studentController.displayThatLessonData
);
